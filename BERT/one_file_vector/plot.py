...
sns.boxplot(x='PromptID', y='HeadScore', data=data, showmeans=True, meanline=True)
...
# Save the plot
plt.savefig("BERT/one_file_vector/plots/HeadScoreP1.pdf", format="pdf")
...
plt.subplot(3, 1, 1)
sns.boxplot(x='PromptID', y='UT', data=data, showmeans=True, meanline=True)
...
plt.subplot(3, 1, 2)
sns.boxplot(x='PromptID', y='UT1', data=data, showmeans=True, meanline=True)
...
plt.subplot(3, 1, 3)
sns.boxplot(x='PromptID', y='UT2', data=data, showmeans=True, meanline=True)
...
plt.tight_layout()
plt.savefig("BERT/one_file_vector/plots/UTP1.pdf", format="pdf")
